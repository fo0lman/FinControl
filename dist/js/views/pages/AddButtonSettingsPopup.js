define([
    ...
    var AddButtonsSettingsPopup;
    AddButtonsSettingsPopup = Backbone.View.extend({
        ...
        initialize: function() {
            this.template = Handlebars.compile(JST.AddButtonSettingsPopup());
    ...
    return AddButtonsSettingsPopup;
});